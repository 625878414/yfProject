  ...
  <div class="source-index">
    <div class="les-table-toolbar">
      ...
      <div>
        ...
        <a-select
          ...
          placeholder="来源"
        >
          <a-select-option value="0"> BigData </a-select-option>
          <a-select-option value="1"> JDBC </a-select-option>
          <a-select-option value="2"> Kafka </a-select-option>
        </a-select>
    ...
    <div>
      <a-drawer
        ...
        width="500px"
      >
        <a-spin :spinning="editSpin" size="large">
          <vue-scroll :style="'height:' + (bodyHeight - 40) + 'px;'">
            <p v-show="!editAble" class="prompt">
              提示：此数据源已被使用，只可修改名称及描述。
            </p>
            <a-form-model
              :model="formData"
              layout="vertical"
            ...
            >
              ...
              <a-form-model-item
                v-show="formData.sourceType == '1' && formData.sourceType != '2'"
                label="类型名称"
                prop="typeName"
              >
                <a-select
                ...
                >
                  <a-select-option
                    v-for="typeName in typeNameList"
                    :key="typeName"
                    :value="typeName"
                  >
                    {{ typeName }}
              ...
              <a-form-model-item label="查询用户名" v-show="formData.sourceType === '1'">
                <a-input
                  v-model="formData.usernameQuery"
                  placeholder="最多输入20个字符"
                  :maxLength="20"
                  :disabled="!editAble"
                />
              ...
              <a-form-model-item label="URL" prop="url">
                ...
                >
                  ...
                  <span
                    class="copy"
                    v-clipboard:copy="'jdbc:mysql://192.168.110.228:3306/'"
                    v-clipboard:success="onCopy"
                  >
                    <a-tooltip>
                      <template slot="title"> 复制模板 </template>
                      <a-icon type="copy" style="cursor: pointer;" />
                    </a-tooltip>
                  </span>
                </div>
                <div
                ...
                >
                  ...
                  <span
                    class="copy"
                    v-clipboard:copy="'jdbc:oracle:thin:@192.168.110.228:1524/xe'"
                    v-clipboard:success="onCopy"
                  >
                    <a-tooltip>
                      <template slot="title"> 复制模板 </template>
                ...
                <div v-else class="copyParent">
                  ...
                  <span
                    class="copy"
                    v-clipboard:copy="'http://hdp2.les.com:21000/api/atlas/v2'"
                    v-clipboard:success="onCopy"
                  >
                    <a-tooltip>
                      <template slot="title"> 复制模板 </template>
          ...
          <div class="les-drawer-form-footer">
            ...
            <a-button type="primary" @click="save" :loading="btnLoading">保存</a-button>
          </div>
        </a-spin>
      </a-drawer>
    </div>
...
function checkData(rule, value, callback) {
  if (value) {
    if (/[\u4E00-\u9FA5]/g.test(value)) {
      callback(new Error("url不能包含中文字符!"));
    } else {
      callback();
    }
  }
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          align: "center",
          customRender: text =>
            text == "0" ? "BigData" : text == "1" ? "JDBC" : text == "2" ? "Kafka" : "未知"
        },
        {
          dataIndex: "typeName",
          title: "类型",
      ...
      tableData: [
        ...
        //   description:"mysql库",
        //   delAble:true,
        //   updateTime:"2021-07-24 12:38:22"
        // },
        // {
        //   name:"b_oracle",
        //   sourceType:"1",
        ...
        //   description:"oracle库",
        //   delAble:false,
        //   updateTime:"2021-07-22 09:12:28"
        // },
        // {
        //   name:"c_kafka",
        //   sourceType:"2",
        ...
        //   description:"kafka",
        //   delAble:true,
        //   updateTime:"2021-07-25 11:12:45"
        // },
      ],
      loading: false,
      drawerTitle: "新增",
