    ...
    <a-modal v-model="addVisible" title="新增项目" :maskClosable="false">
      ...
      >
        ...
        <a-form-model-item label="别名" prop="alias">
          <a-input v-model="formData.alias" placeholder="请输入别名" :maxLength="10"> </a-input>
        </a-form-model-item>
        ...
        <a-form-model-item label="项目描述">
          <a-input v-model="formData.description" type="textarea" placeholder="请输入描述" :maxLength="100"> </a-input>
        </a-form-model-item>
      </a-form-model>
    </a-modal>
  </div>
