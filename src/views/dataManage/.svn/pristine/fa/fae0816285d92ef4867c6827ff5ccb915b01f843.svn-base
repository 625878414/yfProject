      ...
      <div class="form" v-if="!isItInitialized">
        ...
        >
          ...
          <a-form-model-item label="用户名" prop="username">
            <a-input v-model="formData.username" placeholder="最多输入20个字符" :maxLength="20" />
          </a-form-model-item>
          ...
          <div style="position: relative">
            ...
            <div v-else>
              ...
              <a-form-model-item label="URL" prop="url">
                <div
                  v-if="formData.authMethod == 'org.apache.hive.jdbc.HiveDriver'"
                  class="copyParent"
                >
                  <a-input
                    v-model="formData.url"
                    placeholder="jdbc:hive2 ://192.168.110.58:10000/defalt"
                    :maxLength="100"
                  />
                  <span
                    class="copy"
                    v-clipboard:copy="'jdbc:hive2 ://192.168.110.58:10000/defalt'"
          ...
          <a-form-model-item label="URL" prop="url" v-show="formData.sourceType == '1'">
            <div v-if="formData.driverClassName == 'com.mysql.cj.jdbc.Driver'" class="copyParent">
              <a-input
                v-model="formData.url"
                :maxLength="100"
              ...
              <span
                class="copy"
                v-clipboard:copy="
                  'jdbc:mysql://192.168.110.228:3306/test?useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai'
                "
                v-clipboard:success="onCopy"
              >
                <a-tooltip>
        ...
        <a-spin :spinning="loading" size="large">
          <a-descriptions bordered :column="1">
            ...
            <a-descriptions-item label="仓库名称">
              {{ warehouseInformation.name ? warehouseInformation.name : "无" }}
            </a-descriptions-item>
